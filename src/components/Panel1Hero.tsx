    ...
    >
      ...
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center z-10">
        ...
        >
          ...
          <motion.p 
            variants={textVars}
            className="text-[#60738A] text-base md:text-lg font-light leading-relaxed mb-8 max-w-2xl"
          >
            Sapphire Ltd operates at the intersection of flexibility and structural institutional alignment. We provide customized, long-term financing matrices across the capital spectrum to fuel middle-market champions.
          </motion.p>
