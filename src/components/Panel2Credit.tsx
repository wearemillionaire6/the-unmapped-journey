...
export default function Panel2Credit({ scrollProgress }: { scrollProgress: MotionValue<number> }) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 border-t border-[#60738A]/20 pt-8">
          ...
          <div className="md:px-8 first:pl-0 flex flex-col justify-between h-80">
            <div>
              ...
              <div className="mb-6">
                <ScrollRevealText
                  text="First-lien senior debt vehicles optimized for lower middle-market scalability. Providing senior capital access with robust covenant protection."
                  className="text-slate-400 text-xs sm:text-sm font-light leading-relaxed"
          ...
          <div className="md:px-8 border-t md:border-t-0 md:border-l border-[#60738A]/20 flex flex-col justify-between h-80 pt-8 md:pt-0">
            <div>
              ...
              <div className="mb-6">
                <ScrollRevealText
                  text="Junior capital layers tailored for sponsor-backed buyouts, recapitalizations, and significant cross-border corporate scale-ups."
                  className="text-slate-400 text-xs sm:text-sm font-light leading-relaxed"
                  scrollProgress={scrollProgress}
                  range={[0.12, 0.22]}
                />
          ...
          <div className="md:px-8 border-t md:border-t-0 md:border-l border-[#60738A]/20 flex flex-col justify-between h-80 pt-8 md:pt-0 last:pr-0">
            <div>
              ...
              <div className="mb-6">
                <ScrollRevealText
                  text="Special-situation capital optimization pipelines backed by strong infrastructure assets and strategic operating receivables."
                  className="text-slate-400 text-xs sm:text-sm font-light leading-relaxed"
                  scrollProgress={scrollProgress}
                  range={[0.18, 0.28]}
                />
