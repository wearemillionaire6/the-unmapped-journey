    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex items-center justify-between border-b border-white/5 pb-6">
        <div className="flex items-center gap-2.5 text-white">
          ...
          <span className="font-serif text-sm tracking-[0.2em] font-medium border-b-2 border-a-volt/0 pb-1">SAPPHIRE LTD</span>
        </div>
      ...
      <div className="relative w-full max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12 z-10 py-8">
        ...
        <div className="max-w-md text-center md:text-left">
          ...
          <div className="mb-6">
            <ScrollRevealText
              text="Our investment committee reviews capital request submissions and manager proposals on a rolling basis. Partner with Sapphire Ltd."
